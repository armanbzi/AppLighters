...
export default function Portfolio() {
    ...
    return (
        <Layout>
            <Box sx={{height:{xs:5000,sm:5000,lg:1720},backgroundColor:'#3f3648'}}>
...
<br/><br/><br/>
            ...
            <Stack direction={{xs:"column",sm:"column",lg:"row"}} spacing={{xs:0, sm:0, lg:9}} sx={{marginLeft:{xs:0,sm:24,lg:0}}}>
                <Box sx={{width:220,height:300}}>
                    <PrCards frameWorks={['NextJs','MUI','React']} name={"AppLighters"} img={'/images/APP_Lighters.png'}
                             url={'www.applighters.com'}/>
                </Box>
                <Box sx={{width:220,height:300}}>
